...
const StreaksScreen = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      // const completionsSubsription = client.subscribe(
      //   completionsChannel,
      //   (response: RealtimeResponse) => {
      //     // console.log('Realtime event:', response.events);
      //     // console.log('Payload:', response.payload);
  ...
  const getStreakData = (habitId: string): StreakData => {
    const haibitCompletions = completedHabits
    ...
    let streak = 0;
    let bestStreak = 0;
    let total = haibitCompletions.length;

    let lastDate: Date | null = null;
    let currentStreak = 0;

    haibitCompletions?.forEach((c) => {
  ...
  const habitStereaks = habits.map((habit) => {
  ...
  const rankedHabits = habitStereaks.sort(
    ...
    <View style={styles.container}>
      ...
      {rankedHabits.length > 0 && (
        <View style={styles.rankingContainer}>
          <Text style={styles.rankingTitle}>🏅 Top Steaks</Text>
              ...
              <Card.Content>
                ...
                <View style={styles.statsRow}>
                  <View style={styles.statBadge}>
                    ...
                    <Text style={styles.statLabel}> Cuurrent </Text>
                  </View>
